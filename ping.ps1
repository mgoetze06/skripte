...
$computers = @("192.168.0.88","192.168.0.89","192.168.0.94")

foreach($computer in $computers) {
	Test-ComputerConnection -ComputerName $computer
}

Get-Content .\computers.txt | Test-ComputerConnection -Verbose